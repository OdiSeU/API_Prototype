...
public:
    Character(int id=0, float x = 500, float y = 500, int speed = 100, int jumppower = 10, int jumpnum = 1, int heart = 5, COLORREF rgb = RGB(0, 0, 0));
    ...
    void SetSpec(int id, int speed, int jumppower, int jumpnum, int heart, COLORREF rgb);
    void PastSaves();
